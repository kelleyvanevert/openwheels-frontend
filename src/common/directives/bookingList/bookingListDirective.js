          ...
          return bookingService.forResource({
            ...
            $scope.getTotalHours = function(){
              for(var i = 0; i < $scope.bookings.length; i++){
                if([50076, 53808, 904804, 904803, 886218, 904763, 924281, 61664, 912291, 921428, 909163, 916080, 877081, 868897, 865782, 886219, 912372, 911835, 66244].indexOf($scope.bookings[i].contract.id) < 0) {
